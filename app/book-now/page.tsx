          ...
          <Card className="border-none shadow-2xl">
            <CardContent className="p-6 sm:p-10">
              <div className="text-center mb-8">
                <h1 className="text-3xl sm:text-4xl font-bold mb-3 text-gray-900">Book Your Event</h1>
                <p className="text-base sm:text-lg text-gray-600">
                  Fill out the form below to start planning your unforgettable event with us.
                </p>
              </div>
              ...
              {isSubmitted ? (
                <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                  ...
                  <p className="text-green-700">
                    Thank you for your interest! You will be redirected to WhatsApp to send your booking details.
                  </p>
                </div>
              ) : (
